...
function ProductSpecifications() {
	const items = [
		{ name: "Diepte", value: "855 MM" },
		{ name: "Breedte", value: "950 MM" },
		{ name: "Hoogte frame", value: "1.998 MM" },
		{ name: "Hoogte filterkamer", value: "1.812 MM" },
		{ name: "Inlet cross", value: "100 MM" },
		{ name: "Outlet cross", value: "140 MM" },
