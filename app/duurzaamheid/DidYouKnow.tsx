import bg from "@/public/images/duurzaamheid-hero-2.jpg";
	...
	return (
		<div className={`py-20 px-5 relative`}>
			<Image
				...
				objectFit="cover"
			/>
			<div className="flex flex-col gap-5 text-center bg-black/10 backdrop-blur  text-white rounded-lg max-w-5xl mx-auto p-8">
